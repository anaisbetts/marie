...
export default function index() {
  return (
    <>
      ...
      <p>
        <strong>Note:</strong> This document is itself written using Markdown;
        you can{' '}
      ...
      <p>
        When you <em>do</em> want to insert a <code>&lt;br /&gt;</code> break
      ...
      <p>
        ...
        hashes don&#39;t even need to match the number of hashes used to open
        the header. (The number of opening hashes determines the header level.)
      </p>
      <h3 id="blockquotes">Blockquotes</h3>
      <p>
        Markdown uses email-style <code>&gt;</code> characters for blockquoting.
        If you&#39;re familiar with quoting passages of text in an email
        message, then you know how to create a blockquote in Markdown. It looks
        best if you hard wrap the text and put a <code>&gt;</code> before every
        line:
      </p>
      <blockquote>
        <p>
      ...
      <p>
        ...
        both <code>&lt;pre&gt;</code> and <code>&lt;code&gt;</code> tags.
      </p>
      <p>
      ...
      <p>
        ...
        (<code>&lt;</code> and <code>&gt;</code>) are automatically converted
        into HTML entities. This makes it very easy to include example HTML
        source code using Markdown -- just paste it and indent it, and Markdown
        will handle the hassle of encoding the ampersands and angle brackets.
        For example, this:
      </p>
      <pre>
        <code>
          &lt;div class=&quot;footer&quot;&gt; &amp;copy; 2004 Foo Corporation
          &lt;/div&gt;
        </code>
      </pre>
      <p>
      ...
      <p>
        ...
        after the link text&#39;s closing square bracket. Inside the
      ...
      <p>
        ...
        ). Unlike a pre-formatted code block, a code span indicates code within
        a normal paragraph. For example:
      </p>
      <p>
